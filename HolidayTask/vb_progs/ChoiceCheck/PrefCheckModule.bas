Attribute VB_Name = "PrefCheckModule"
Option Explicit

'this is the number of columns in the input *.csv file
Public Const iNumberOfInputColumns = 15
...
Type detailArray
    ...
    Chosen(0 To nDisplay - 1) As String
    Latency(0 To nDisplay - 1) As Single
    HolidayRating(0 To nDisplay - 1) As Single
    HolidayRateBin(0 To nDisplay - 1) As Single
    DifficultyRating(0 To nDisplay - 1) As Single
    DifficultyRateBin(0 To nDisplay - 1) As Single
    NonAffectiveAnswer(0 To nDisplay - 1) As String
End Type
